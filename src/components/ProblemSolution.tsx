          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              {problems.map((problem, index) => (
                <div key={index} className="bg-white p-8 rounded-2xl shadow-subtle border border-border transition-smooth hover:shadow-primary min-h-[180px] flex">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              {solutions.map((solution, index) => (
                <div key={index} className="bg-white p-8 rounded-2xl shadow-subtle border border-border transition-smooth hover:shadow-accent min-h-[180px] flex">
                  <div className="flex items-start space-x-4 w-full">
